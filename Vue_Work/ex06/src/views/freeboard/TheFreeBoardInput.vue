  ...
  <div>
    ...
    <div class="p-5">
      <input
        ...
        v-model="nickname"
        placeholder="ㅇㅇ"
        class="m-4 w-3/12 p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-700 placeholder-gray-400 bg-white"
      />
      <input
        type="text"
        v-model="password"
...
const save = () => {
  const data = {
    f_title: title.value,
    f_body: content.value,
    f_nickname: nickname.value,
